...
import com.tsveti.javacourse.Good;
import com.tsveti.javacourse.Liquid;
import com.tsveti.javacourse.Solid;

public class TestGoods {
    public static void main(String[] args) {
        Liquid glue = new Liquid("Acme Glue", 2334, 4,
                Good.UnitOfMeasureType.LITER, false, 15, 6);
        ...
        Solid anvil = new Solid("Acme Anvil", 1668, 0.3,
                Good.UnitOfMeasureType.CUBIC_METER, false, 5000, 0.5, 0.5);
